...
class main():
    ...
    def update_profile_settings(self, iteminfo, profilename, profileid, darkmode):
        ...
        if iteminfo["browsertype"] == "chromium":
            ...
            #Use appropriate Solstice specific theme TODO: Check user isn't using a custom theme before setting it
            if darkmode == True:
                result["vivaldi"]["theme"]["schedule"]["o_s"]["light"] = "ice-dark"
                result["autogenerated"]["theme"]["color"] = -13485757
            else:
                result["vivaldi"]["theme"]["schedule"]["o_s"]["light"] = "ice"
                result["autogenerated"]["theme"]["color"] = -5919045
